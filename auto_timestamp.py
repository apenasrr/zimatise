...
try:
    ...
    utils.add_path_script_folders(['mass_videojoin', 'timestamp_link_maker'])
    import zimatise_monitor
    import mass_videojoin
    from timestamp_link_maker import timestamp_link_maker
...
def process_auto_timestamp(project_path):
    ...
    try:
        ...
        timestamp_link_maker(folder_path_output=folder_path_project_process,
