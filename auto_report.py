...
def process_make_report(project_path):
    ...
    file_path_report = os.path.join(folder_path_project_process, 'video_details.xlsx')
    try:
        mass_videojoin.step_create_report_filled(project_path,
                                                 file_path_report,
